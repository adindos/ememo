                    				...
                    				foreach($departmentLists as $dept):
                    					if(isset($budgets[$i])):
	                    					if(($budgets[$i]['BNewAmount']['department_id'] == $dept) && ($budgets[$i]['BNewAmount']['item_id'] == $item) ):
	                    						echo "<td class='text-center'>"."(curitem:".$item.")(itemid:".$budgets[$i]['BNewAmount']['item_id'].")-(curdept:".$dept.")(deptid:".$budgets[$i]['BNewAmount']['department_id'].")</td>";
                    						...
                    						echo "<td class='text-center'> last </td>";
                    					endif;
