<section class="mems-content pdf-text-overwrite">
        ...
        <table class='pdf table'>
            ...
            <tr>
                <td class='bold noborder' style="width:14%">
                    <strong class='subject'>Company</strong>
                </td>
                ...
                <td class="noborder" style="width:85%"><span class='pdfdesc'>
                    <?php
                        echo $budgetDetail['Company']['company'];
                    ?></span>
                </td>
            </tr>
            <tr>
                <td class='bold noborder' style="width:14%">
                    <strong class='subject'>Description</strong>
                </td>
                <td class="bold noborder" style="width:1%">
                    :
                </td>
                <td class="noborder" style="width:85%"><span class='pdfdesc'>
                    <?php
                        echo $budgetDetail['Budget']['description'];
                    ?></span>
                </td>
            </tr>
            <tr>
                <td class='bold noborder' style="width:14%">
                    <strong class='subject'>Year</strong>
                </td>
                <td class="bold noborder" style="width:1%">
                    :
                </td>
                <td class="noborder" style="width:85%"><span class='pdfdesc'>
                    <?php
                        echo '01/01/'.$budgetDetail['Budget']['year'].' to '.'31/12/'.$budgetDetail['Budget']['year'];
                    ?></span>
                </td>
            </tr>
        </table>  
	...
	<div class="row col-lg-12">
		<section class="panel">
			...
			<div class="panel-body" style="padding:0 30px" id="bodytext">
    ...
    <?php if (!$deptSpecific||in_array($activeUser['Role']['role_id'], array(17,18)))://show only dept based to non admin users and not budget involved user)://show only if not dept based  ?>
                                    ...
                                    <table class="table table-bordered table-condensed">
                                        ...
                                        <tbody>
                                            <tr style="text-align:justify">
                                                <td colspan="2">
                                                    ...
                                                    <?php 
                                                        if (!empty($reviewer['BStatus'][0]['remark']) && $reviewer['BStatus'][0]['status']=='approved') 
                                                            echo '<h5><b>Remark(s) : </b></h5>'. ($reviewer['BStatus'][0]['remark']);
                                                        ?>
                                                    </p>
                                                </td>
                                                <td colspan="2">
                                                <!-- <h5><b>Remark(s) : </b></h5> -->
                                                <p style="text-align:justify">
                                                    <?php if (!empty($value['BStatus'][0]['remark'])&&$value['BStatus'][0]['status']=='rejected') echo '<h5><b>Remark(s) : </b></h5>'.($value['BStatus'][0]['remark']); ?>
                                                    </p>
                                                </td>
                                                        <td>
                                                            <?php 
                                        ...
                                        <p style="text-align:justify">
                                            <?php 
                                                if (!empty($approver['BStatus'][0]['remark']) && $approver['BStatus'][0]['status']=='approved') 
                                                    echo '<h5><b>Remark(s) : </b></h5>'. ($approver['BStatus'][0]['remark']);
                                                ?>
                                            </p>
                                        </td>
                                        <td colspan="2">
