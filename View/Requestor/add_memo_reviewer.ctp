                ...
                <div class="col-sm-12">
                  <section class="panel">
                    ...
                    <div class="form-group" style="text-align:center"> 
                         ...
                         <button id="editable-sample_new" class="btn btn-success" onclick="window.location.href='<?php echo Router::url(array('controller'=>'Reviewer', 'action'=>'memo'))?>'">  <i class="fa fa-save"></i>  Preview</button>
                    </div>
                    </div> 
                    </section>
                    </div>
