<?php
    $this->Html->addCrumb('Reports', array('controller' => 'report', 'action' => 'budgetTransferReport'));
    $this->Html->addCrumb('Budget Transfer Report', $this->here,array('class'=>'active'));
?>
...
<section class="mems-content">
        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    Filtering Options For Budget Transfer Report
                ...
                <div class="panel-body">
                    <?php
                        ...
                        echo $this->Form->create('Filter', array(
                            'url' => array('controller' => 'report' , 'action' => 'budgetTransferReport'),'id'=>'reportForm'));
                     ?>
                    <div class="col-lg-4">
                    </div>
                    <div class="col-lg-4">
    ...
    <script type="text/javascript" charset="utf-8">
            $('#pdf').on('click',function(){
                $('#reportForm').attr('action','<?php echo ACCESS_URL ?>report/exportTransfer/pdf.pdf');
            });
            $('#excel').on('click',function(){
                $('#reportForm').attr('action','<?php echo ACCESS_URL ?>report/exportTransfer/excel.xlsx');
            });
            $('#filter').on('click',function(){
                $('#reportForm').attr('action','<?php echo ACCESS_URL ?>report/budgetTransferReport');
            });
