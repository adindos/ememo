<?php
    $this->Html->addCrumb('Reports', array('controller' => 'report', 'action' => 'budgetUtilizationReport'));
    $this->Html->addCrumb('Budget Utilization Report', $this->here,array('class'=>'active'));
?>
...
<section class="mems-content">
        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    Filtering Options For Budget Utilization Report
                ...
                <div class="panel-body">
                    <?php
                        ...
                        echo $this->Form->create('Filter', array(
                            'url' => array('controller' => 'report' , 'action' => 'budgetUtilizationReport'),'id'=>'reportForm'));
                     ?>
                    <div class="col-lg-4">
                    </div>
                    <div class="col-lg-4">
    ...
    <div class="row">
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                Budget Utilization Report Summary
                </header>
    ...
    <script type="text/javascript" charset="utf-8">
            $('#pdf').on('click',function(){
                $('#reportForm').attr('action','<?php echo ACCESS_URL ?>report/exportUtilization/pdf.pdf');
            });
            $('#excel').on('click',function(){
                $('#reportForm').attr('action','<?php echo ACCESS_URL ?>report/exportUtilization/excel.xlsx');
            });
            $('#filter').on('click',function(){
                $('#reportForm').attr('action','<?php echo ACCESS_URL ?>report/budgetUtilizationReport');
            });
