<?php
  ...
  $this->Html->addCrumb('Budget Archive', $this->here,array('class'=>'active'));
?>
	...
	<div class="row">
		...
		<div class="col-lg-12">
          ...
          <span class="pull-right">
            ...
            <?php
            echo $this->Html->link('Upload New Budget','#modal-upload-budget-archive',array('class'=>'btn btn-round bg-primary btn-xs margin-left','data-toggle'=>'modal'));
            ?>
					...
					<table class="table table-striped table-advance table-hover dataTable">
						...
						<tbody>
							...
							<tr>
								...
								<td class="text-center"><span class="label blue-bg label-mini"><?php echo $archive['BArchive']['year'] ?></span></td>
		...
		<div class="modal-content">
			<div class="modal-header">
			 ...
			 <?php
                ...
                $model = 'BArchive';
                $options = array('class'=>'form-horizontal','type' => 'file', 'onsubmit' => 'return checkFileSize()',  'inputDefaults' => array('label' => false),'url' =>  array('controller'=>'archive','action'=>'addBudgetArchive'));
			...
			<div class="modal-body">
				...
				<div class="form-group">
					...
					<div class="col-lg-9 col-sm-9">
						<?php
							echo $this->Form->input('filename',array('id' => 'fileinput' ,'type'=>'file','class'=>'file', 'required','accept' => "image,application/pdf,application/vnd.ms-excel, application/vnd.openxmlformats-officedocument.spreadsheetml.sheet, application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document"));
						?>
					</div>
				</div>	
  ...
  <div class="modal fade" id="modal-edit-upload-budget-archive" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  				...
  				<div class="form-group">
  					...
  					<div class="col-lg-9 col-sm-9">
  						<?php
  						    ...
  						    echo $this->Form->input('company_id',array('type'=>'select','options'=>$companies_list,'class'=>'select full-width','required','id' => 'edit-archivecompany-id', 'empty'=>'-- Please select a company --'));
  						?>
  					</div>
  				</div>
  				<div class="form-group">
    ...
    <script type="text/javascript">
    	...
    	function checkFileSize() {
    	    ...
    	    if (!input) {
    	        alert('couldnt find the fileinput element');
    	        return;

    	    }
    	    else if (!input.files) {
    	    	alert('This browser doesnt seem to support the files property of files inputs');
    	    	return;
    	        ...
    	        if(file.size > 10000000){
    	        	...
    	        	alert('File is too large. Maximum size is MB 10');
