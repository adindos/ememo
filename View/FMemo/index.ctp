...
<section class="mems-content">
				...
				<div class="panel-body">
					<?php
	                    ...
	                    echo $this->Form->create('Filter', array(
	                        'url' => array('controller' => 'fMemo' , 'action' => 'index'),'id'=>'reportForm'));
	                 ?>
	...
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<section class="panel">
				<?php
                    echo $this->Form->create('FMemo',array('url'=>array('controller'=>'FMemo','action'=>'deleteMemoMulti','view'=>$viewData,'from'=>$fromData,'to'=>$toData),'class'=>'form-horizontal','type'=>'file','inputDefaults'=>array('label'=>false,'legend'=>false,'div'=>false)));
                  ?>
				<header class="panel-heading">
								...
								<td class="text-center">
									<!-- <div class="btn-group btn-group-xs"> -->
										<?php
											...
											if($m['FMemo']['submission_no'] == 0)://havent submitted
											...
											if($progress!=100):
												//phase 2:disable memo activity if memo access is disabled
 											if (!$setting['Setting']['financial_memo'])
 												echo $this->Html->link('<i class="fa fa-times"></i>',array('controller'=>'FMemo','action'=>'deleteMemo',$m['FMemo']['memo_id'],'view'=>$viewData,'from'=>$fromData,'to'=>$toData),array('escape'=>false,'class'=>'btn btn-danger btn-xs tooltips','data-original-title'=>'Delete'),'Are you sure? This action cannot be undone.');
	 										endif;
										?>
