<?php
  ...
  $this->Html->addCrumb('Temporary Ref. No : 000/'.$memo_id, array('controller' => 'NfMemo2', 'action' => 'dashboard',$encMemoID));
  $this->Html->addCrumb('Confirm Non Financial Memo', $this->here,array('class'=>'active'));
?>
	...
	<div class="col-sm-12">
	  	<section class="panel">
			<header class="panel-heading">
				Complete the form below to confirm
		   	</header>
	   		<div class="panel-body">
	   			<?php
	   				echo $this->Form->create('NfMemo',array('url'=>array('controller'=>'NfMemo2','action'=>'confirmMemo'),
	   														'class'=>'form-horizontal tasi-form','type'=>'file',
	   														'onSubmit'=>'return confirm("By confirming the memo, there would be no changes possible after. Are you sure you want to confirm this memo?")',
	   			...
	   			?>
	   				...
	   				<div class="col-sm-3">
	   					...
	   					<div class="col-lg-8 col-sm-8">
		   					<?php
		   						echo $this->Form->input('NfMemo.remark',array('type'=>'textarea','class'=>'wysihtml5 form-control'));
		   					?>
		   				</div>
	   				</div>
	   				...
	   				<div class="form-group">
	   				 <div class="col-sm-3">
	   					...
	   					<div class="col-lg-8 col-sm-8">
		   					<?php
		   						// $reviewers = array();
		   						echo $this->Form->input('NfReviewer.reviewer',array('type'=>'select','options'=>$reviewers,'class'=>'select2-sortable full-width','multiple'=>'multiple','style'=>'width:100%'));
		   					?>
	   				...
	   				<div class="col-sm-3">
	   					...
	   					<div class="col-lg-8 col-sm-8">
		   					<?php
		   						// $reviewers = array();
		   						echo $this->Form->input('NfReviewer.recommender',array('type'=>'select','options'=>$recommenders,'class'=>'select2-sortable full-width','multiple'=>'multiple','style'=>'width:100%'));
		   					?>
	   				...
	   				<div class="col-sm-3">
	   					...
	   					<div class="col-lg-8 col-sm-8">
		   					<?php
		   						// $approvers = array();
		   						echo $this->Form->input('NfReviewer.approver',array('type'=>'select','options'=>$approvers,'class'=>'select2-sortable full-width','multiple'=>'multiple','style'=>'width:100%'));
		   					?>
	   				...
	   				<div class="form-group" style="text-align:center">
	   					<?php
	   						echo $this->Html->link("<i class='fa fa-times'></i> Cancel",array('controller'=>'user','action'=>'userDashboard'),array('escape'=>false,'class'=>"btn btn-default"));
	   						echo "&nbsp;&nbsp;";
	   						echo $this->Form->button("<i class='fa fa-save'></i> Confirm Memo",array('type'=>'submit','class'=>'btn btn-success'),__('Are you sure? This memo cannot be edited once it is submitted.'));
	   						echo $this->Form->end();
	   					?>
	   				</div>
		  	</div> 
