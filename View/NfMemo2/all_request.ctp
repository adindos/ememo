...
<section class="mems-content">
				...
				<div class="panel-body">
					<?php
	                    ...
	                    echo $this->Form->create('Filter', array(
	                        'url' => array('controller' => 'NfMemo2' , 'action' => 'allRequest'),'id'=>'reportForm'));
	                 ?>
	...
	<div class="row">
		...
		<div class="col-lg-12">
			...
			<section class="panel">
				<?php
                    echo $this->Form->create('NfMemo',array('url'=>array('controller'=>'NfMemo2','action'=>'deleteMemoMulti','view'=>$viewData,'div'=>$groupData,'dept'=>$deptData,'user'=>$userData,'from'=>$fromData,'to'=>$toData),'class'=>'form-horizontal','type'=>'file','inputDefaults'=>array('label'=>false,'legend'=>false,'div'=>false)));
